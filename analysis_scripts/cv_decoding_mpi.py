...
if __name__ == '__main__':
    ...
    if com.rank == 0:
        ...
        fname = '/mnt/sdb1/nc_data/EC2_hg.h5'
    ...
    tasks = itertools.product(dims, np.arange(10))
    ...
    for ii, task in enumerate(tasks):
        ...
        fca_scores[1] = lqgmodel.score(coef=pca_model.components_.T[:, 0:d])
        ...
        print('rank %d completed in %f' % (time.time() - t0))
