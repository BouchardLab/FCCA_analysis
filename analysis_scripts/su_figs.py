...
if __name__ == '__main__':
    ...
    ax.vlines(np.log10(q1_pca), -5, 0, color='k')
    ax.hlines(np.log10(q1_fca), -5, 0, color='k')
    ...
    ax.annotate('Overall Spr-r=%.2f' % r, (-4.8, -1.2), fontsize=14)
    ax.annotate('Upper-quartile Spr-r=%.2f' % r2, (-4.8, -0.5), fontsize=14)
