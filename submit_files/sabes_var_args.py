...
task_args = [{'estimator': 'uoi', 'penalty': 'scad', 'self_regress':sr, 'continuous':False, 
              'fit_type':'union_only', 'order':order, 'estimation_score':'BIC'} for order in [1, 2, 3, 4, 5] for sr in [True, False]]